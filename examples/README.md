...
Jupyter notebooks that demonstrate how to use the `rice_ml` package.
...
- `load_dataset.py` - helper utility for loading datasets in this folder.

## Notes

- Notebooks are educational and may include exploratory/iterative cells.
- If you changed package source code, restart the notebook kernel before rerunning imports.
